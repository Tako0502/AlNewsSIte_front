                ...
                try {
                    ...
                    if (resData["status"] === "success") {
                        if (dataSkin === "default") {
                            ...
                            $qar.bindTinymceEditor(dataSkin);
        ...
        document.querySelectorAll('button[data-qar-confirm]').forEach(elem => {
            elem.addEventListener('click', function () {
                const okText = this.getAttribute('data-qar-ok'),
                    ...
                    checkboxs = document.querySelectorAll('#' + tableId + ' input.datatable-checkbox');
                        ...
                        if (result.isConfirmed) {
                            try {
                                ...
                                if (checkboxs) {
                                    checkboxs.forEach(elem => {
                                        if (elem.checked) {
                                            formData.append('idList[]', parseInt(elem.getAttribute('data-id')));
                                        }
                                    });
                                }
